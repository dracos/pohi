...
.. raw:: html
   ...
   <lite-youtube videoid="KirwgBgfJD0" params="rel=0"></lite-youtube>
   </details>
...
**Ms Kennedy**: If we could turn up `POL00033169 <https://www.postofficehorizoninquiry.org.uk/evidence/pol00033169-role-contract-manager>`_, please.  These are a series of slides that you've seen about the role of the contract manager.  You say you don't know where these slides are from or the audience but that the content looked accurate; is that right?
...
Turning then to Callendar Square, `FUJ00083815 <https://www.postofficehorizoninquiry.org.uk/evidence/fuj00083815-area-intervention-manager-visit-log>`_. This is an "Area Intervention Manager Visit Log", and we can see the name there is Sandra MacKay, who was the area intervention manager; is that right?
...
**Ms Kennedy**: If we could pull up the next document which is `FUJ00083770 <https://www.postofficehorizoninquiry.org.uk/evidence/fuj00083770-email-chain-re-callender-between-mike-stewart-anne-chambers-brian-trotter-and>`_, please, and if we could turn to page 6, this is an email chain from around the same time -- I think it's the day before that log -- and we can see an email from Sandra MacKay to Shaun Turner copying you in.  It says:
...
**Ms Kennedy**: If we could turn up the next document, `POL00030241 <https://www.postofficehorizoninquiry.org.uk/evidence/pol00030241-email-brian-trotter-sandra-mackay-re-callendar-square-fad-160868>`_, please, this is another email chain with some overlap to the last one but, if we look at this front page, we can see that Shaun Turner -- and scrolling down, please -- is emailing you and Sandra to say:
...
I'm now going to move to ask you some questions about another incident.  If we could turn up `POL00004403 <https://www.postofficehorizoninquiry.org.uk/evidence/pol00004403-email-jaqueline-whitham-neil-barnard-re-winlaton-mill-transaction-error-query>`_, please.  This concerns Winlaton Mill.  Am I saying that correctly?
...
**Mr Jacobs**: I will try it again `WITN02890100 <https://www.postofficehorizoninquiry.org.uk/evidence/witn02890100-witn02890100-louise-dar>`_, it's the witness statement of Louise Dar.  Great, thank you.
