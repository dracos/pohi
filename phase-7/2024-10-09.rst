...
**Mr Beer**: I have had helpfully drawn to my attention a document that maybe rounds this issue off a little.  Can we look at that, please.  POL00142412.  If we go to the last page, please, which is page 7, you will see this is a note from Peters & Peters Solicitors of 24 August 2022.  If we go back to the first page, in the tramlines at the top, it's a disclosure note in relation to, amongst other things, number (2), "A Review of Bonus/ Incentivisation schemes".
...
**Mr Beer**: The report for the transcript -- no need to turn it up -- is POL00423697.  Can you help by confirming that a number of GE papers were produced following the Project Birch report and decisions taken by the GE on the approach to investigations?
